...
const Insights2 = () => {
  ...
  return (
    <div className="flex flex-col gap-6 w-full bg-white h-[fixed] md:flex-row shadow-xl rounded-md  md:h-[400px]">
      {techNews.length > 0 && (
        <>
          <section className="first-container relative flex flex-col gap-4 justify-start items-start w-full md:w-[50%] h-[500px] md:h-[400px] transform scale-x-[-1]">
            <img
              className="w-full h-[500px] md:w-auto md:h-[400px] object-cover"
