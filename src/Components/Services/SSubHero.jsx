...
const SSubHero = () => {
  return (
    <div className="flex flex-col w-full  gap-8  md:gap-0">
      <div className="flex flex-col-reverse    bg-black w-full lg:h-[500px] h-[fixed]    md:flex-row-reverse md:gap-0  justify-start items-start  ">
        <div className=" trapezoid-shape bg-white   lg:h-[500px]  h-[fixed] p-2 w-full md:w-[50%] justify-center items-start px-2 flex flex-col gap-4  md:pl-[6rem]">
          <h4 className="text-blue-950 font-bold text-xl  text-left   md:text-4xl">
            Custom Website & Applications Development
          </h4>
          <h6 className="   text-black w-full   md:w-[80%]  text-base md:text-2xl">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro,
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Voluptatibus exercitationem magnam cupiditate laudantium animi quam,
            esse rem aperiam commodi tempore.ab!
          </h6>
          <div className="flex flex-row gap-4   md:flex-row">
            <button className="bg-blue-950  w-[fixed] text-white md:w-[250px] p-3 h-[50px] justify-center items-center flex ">
              Get Started
            </button>
            <button className="bg-blue-950  w-[fixed] text-white md:w-[250px] p-3 h-[50px] justify-center items-center flex">
              Purchase Service
        ...
        <img
          ...
          className=" item-image-service w-auto md:w-[50%] h-[500px]"
        />
      </div>

      <div className="flex flex-col-reverse     bg-black w-full lg:h-[500px] h-[fixed]    md:flex-row md:gap-0  justify-start items-start ">
        <div className=" trapezoid-shape bg-white   lg:h-[500px]  h-[fixed] p-2 w-full md:w-[50%] justify-center items-start px-2 flex flex-col gap-4  md:pl-[6rem]">
          <h4 className="text-blue-950 font-bold text-xl  text-left   md:text-4xl">
            Custom Website & Applications Development
          </h4>
